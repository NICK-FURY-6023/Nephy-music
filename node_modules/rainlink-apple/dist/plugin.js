...
const credentials = {
    APPLE_TOKEN: 'eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IldlYlBsYXlLaWQifQ.eyJpc3MiOiJBTVBXZWJQbGF5IiwiaWF0IjoxNzEyOTY5NDQxLCJleHAiOjE3MjAyMjcwNDEsInJvb3RfaHR0cHNfb3JpZ2luIjpbImFwcGxlLmNvbSJdfQ.UFr00OkWHnwqPNAXOy5FospHFzX4_hjJU6H-WPU6dquP7KZE5Pe6_CukE3IbPi0EEfzHEvCYwkj84VjKAydnjA',
};
class RainlinkPlugin extends rainlink_3.SourceRainlinkPlugin {
   ...
   */
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (type in this.methods) {
                try {
                    ...
                    const loadType = isTrack ? rainlink_1.RainlinkSearchResultType.TRACK : rainlink_1.RainlinkSearchResultType.PLAYLIST;
    ...
    debug(logs) {
        this.manager ? this.manager.emit(rainlink_4.RainlinkEvents.Debug, `[Rainlink] -> [Plugin] -> [Apple] | ${logs}`) : true;
    }
}
