...
const SpotifyRequest_js_1 = require("./SpotifyRequest.js");
    ...
    constructor(options) {
        ...
        if ((_a = options.clients) === null || _a === void 0 ? void 0 : _a.length) {
            for (const client of options.clients)
                this.requests.push(new SpotifyRequest_js_1.SpotifyRequest(client));
            this.mode = 'multi';
            ...
            this.requests.push(new SpotifyRequest_js_1.SpotifyRequest({
